langDict = {
  ...
  'help_info_config_get'                  : 'Gibt alle Schlüssel der Willowbotkonfigurationsdatei und deren Werte aus. Wird ein bestimmter Schlüssel [Schlüssel] als zusätzliches Argument übergeben, wird nur ebendieser Schlüssel und dessen Wert angezeigt.',
  ...
  'localeAbbreviation'                    : 'Sprachkürzel',
  'message'                               : 'Nachricht',
  'name'                                  : 'Name',
  'option'                                : 'Option',
  'options'                               : 'Optionen',
